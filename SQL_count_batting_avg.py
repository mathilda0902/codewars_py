...
# hitter's performace. Batting average is calculated by taking all the players hits
# and dividing it by their number of at_bats, and it is usually displayed as a 3
# digit decimal (i.e. 0.300).
#
